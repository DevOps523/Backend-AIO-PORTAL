        ...
        <form onSubmit={createProduct} className='addWebsiteform'>
            ...
            <div className='w-100 flex flex-col flex-left mb-2' data-aos="fade-up">
                ...
                <select onChange={(e) => setBlogcategory(Array.from(e.target.selectedOptions, option => option.value))} name="catergory" id="catergory" multiple value={blogcategory} >
                    ...
                    <option value="graphicresources">Graphic Resources</option>
            ...
            <div className='w-100 flex flex-col flex-left mb-2' data-aos="fade-up">
                ...
                <select onChange={(e) => setTags(Array.from(e.target.selectedOptions, option => option.value))} name="tags" id="tags" multiple value={tags}>
                    <option value="learnandgrow">LearnAndGrow</option>
                    <option value="creativedesigns">CreativeDesigns</option>
                    <option value="softwaresolutions">SoftwareSolutions</option>
                    <option value="gameon">GameOn</option>
                    <option value="movies">Movies</option>
                    <option value="series">Series</option>
                    <option value="anime">Anime</option>
                    <option value="graphicassets">GraphicAssets</option>
                    <option value="techtutorials">TechTutorials</option>
                    <option value="gamingcommunity">GamingCommunity</option>
                    <option value="templatelibrary">TemplateLibrary</option>
                    <option value="resourcecenter">ResourceCenter</option>
                    <option value="mobileapps">Mobile Apps</option>
                </select>
