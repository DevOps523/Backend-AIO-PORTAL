              ...
              <div className="blogscategory flex flex-center">
                <table data-aos="fade-up">
                  ...
                  <tbody>
                    <tr>
                      <td>Courses</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "courses").length}</td>
                    </tr>
                    <tr>
                      <td>Entertainment</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "entertainment").length}</td>
                    </tr>
                    <tr>
                      <td>Graphic Resources</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "graphicresources").length}</td>
                    </tr>
                    <tr>
                      <td>Software</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "software").length}</td>
                    </tr>
                    <tr>
                      <td>Games</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "games").length}</td>
                    </tr>
                    <tr>
                      <td>Templates</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "templates").length}</td>
                    </tr>
                    <tr>
                      <td>Mobile Apps</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "mobileapps").length}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
